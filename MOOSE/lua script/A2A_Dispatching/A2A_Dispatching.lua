...
-- definisco i range
EWR_Blue = DETECTION_AREAS:New( DetectionGroupBlue, 50000 )
A2ADispatcher_Blue = AI_A2A_DISPATCHER:New( EWR_Blue )
A2ADispatcher_Blue:SetEngageRadius()
A2ADispatcher_Blue:SetGciRadius()
...
-- definisco i range
EWR_Red = DETECTION_AREAS:New( DetectionGroupRed, 50000 )
A2ADispatcher_Red = AI_A2A_DISPATCHER:New( EWR_Red )
A2ADispatcher_Red:SetEngageRadius()
A2ADispatcher_Red:SetGciRadius()
