...
missionCommands.addCommand('Zone 1', M3,function() trigger.action.setUserFlag(131,1) end, nil)
missionCommands.addCommand('Zone 2', M3,function() trigger.action.setUserFlag(132,1) end, nil)
missionCommands.addCommand('Zone 3', M3,function() trigger.action.setUserFlag(133,1) end, nil)
missionCommands.addCommand('Zone 4', M3,function() trigger.action.setUserFlag(134,1) end, nil)
missionCommands.addCommand('Zone 5', M3,function() trigger.action.setUserFlag(135,1) end, nil)

missionCommands.addCommand('Air defense', M4,function() trigger.action.setUserFlag(141,1) end, nil)
missionCommands.addCommand('Infantery', M4,function() trigger.action.setUserFlag(142,1) end, nil)
missionCommands.addCommand('Mooving targets', M4,function() trigger.action.setUserFlag(143,1) end, nil)
